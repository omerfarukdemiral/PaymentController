 ...
 *   https://datatables.net/download/#bs4/jq-3.3.1/dt-1.10.18/af-2.3.3/b-1.5.6/r-2.2.2/rr-1.2.4/sl-1.3.0
 *
 * Included libraries:
 *   jQuery 3 3.3.1, DataTables 1.10.18, AutoFill 2.3.3, Buttons 1.5.6, Responsive 2.2.2, RowReorder 1.2.4, Select 1.3.0
 */
...
(function(h) {
    ...
    n.ext = x = {
        buttons: {},
        classes: {},
        build: "bs4/jq-3.3.1/dt-1.10.18/af-2.3.3/b-1.5.6/r-2.2.2/rr-1.2.4/sl-1.3.0",
        errMode: "alert",
        feature: [],
        search: [],
...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.arrayIteratorImpl = function(b) { var g = 0; return function() { return g < b.length ? { done: !1, value: b[g++] } : { done: !0 } } };
$jscomp.arrayIterator = function(b) { return { next: $jscomp.arrayIteratorImpl(b) } };
$jscomp.ASSUME_ES5 = !1;
$jscomp.ASSUME_NO_NATIVE_MAP = !1;
$jscomp.ASSUME_NO_NATIVE_SET = !1;
$jscomp.SIMPLE_FROUND_POLYFILL = !1;
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(b, g, h) { b != Array.prototype && b != Object.prototype && (b[g] = h.value) };
...
$jscomp.Symbol = function() { var b = 0; return function(g) { return $jscomp.SYMBOL_PREFIX + (g || "") + b++ } }();
$jscomp.initSymbolIterator = function() {
    $jscomp.initSymbol();
    var b = $jscomp.global.Symbol.iterator;
    b || (b = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol("iterator"));
    "function" != typeof Array.prototype[b] && $jscomp.defineProperty(Array.prototype, b, { configurable: !0, writable: !0, value: function() { return $jscomp.iteratorPrototype($jscomp.arrayIteratorImpl(this)) } });
    $jscomp.initSymbolIterator = function() {}
};
...
$jscomp.iteratorFromArray = function(b, g) {
    ...
    var h = 0,
        m = {
            next: function() {
                if (h < b.length) { var l = h++; return { value: g(l, b[l]), done: !1 } }
...
$jscomp.polyfill = function(b, g, h, m) {
    if (g) {
        ...
        m = h[b];
        g = g(m);
        g != m && null != g && $jscomp.defineProperty(h, b, { configurable: !0, writable: !0, value: g })
    }
};
...
(function(b) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(g) { return b(g, window, document) }) : "object" === typeof exports ? module.exports = function(g, h) {
        g || (g = window);
    ...
    var l = b.fn.dataTable,
        ...
        k = function(a, d) {
            ...
            this.c = b.extend(!0, {}, l.defaults.autoFill,
                k.defaults, d);
            this.s = { dt: new l.Api(a), namespace: ".autoFill" + w++, scroll: {}, scrollInterval: null, handle: { height: 0, width: 0 }, enabled: !1 };
            this.dom = {
    ...
    b.extend(k.prototype, {
        ...
        enable: function(a) {
            ...
            this.s.enabled = !0;
            this._focusListener();
            this.dom.handle.on("mousedown", function(a) { d._mousedown(a); return !1 });
            return this
        },
        disable: function() {
            this.s.enabled = !1;
        ...
        _attach: function(a) {
            var d = this.s.dt,
                ...
                f = this.dom.handle,
                e = this.s.handle;
            c && -1 !== d.columns(this.c.columns).indexes().indexOf(c.column) ? (this.dom.offsetParent || (this.dom.offsetParent = b(d.table().node()).offsetParent()), e.height && e.width || (f.appendTo("body"), e.height =
        ...
        _actionSelector: function(a) {
            var d = this,
                ...
                f = k.actions,
                e = [];
            b.each(f, function(d, b) { b.available(c, a) && e.push(d) });
            if (1 === e.length && !1 === this.c.alwaysAsk) {
                ...
                b.each(e, function(e, p) {
                    n.append(b("<li/>").append('<div class="dt-autofill-question">' + f[p].option(c, a) + "<div>").append(b('<div class="dt-autofill-button">').append(b('<button class="' + k.classes.btn + '">' + c.i18n("autoFill.button", "&gt;") + "</button>").on("click", function() {
        ...
        _drawSelection: function(a, d) {
            ...
            var f = b(this.dom.start),
                e = { row: this.c.vertical ? c.rows({ page: "current" }).nodes().indexOf(a.parentNode) : d.row, column: this.c.horizontal ? b(a).index() : d.column };
            a = c.column.index("toData", e.column);
            var p = c.row(":eq(" + e.row + ")", { page: "current" });
            p = b(c.cell(p.index(), a).node());
            if (c.cell(p).any() && -1 !== c.columns(this.c.columns).indexes().indexOf(a)) {
                this.s.end = e;
                c = d.row <
                    e.row ? f : p;
        ...
        _editor: function(a) {
            ...
            if (c) {
                for (var b = {}, e = [], p = c.fields(),
                        n = 0, h = a.length; n < h; n++)
                    for (var g = 0, l = a[n].length; g < l; g++) {
                        var q = a[n][g],
                            t = d.settings()[0].aoColumns[q.index.column],
                            k = t.editField;
                        if (k === m) { t = t.mData; for (var u = 0, r = p.length; u < r; u++) { var v = c.field(p[u]); if (v.dataSrc() === t) { k = v.name(); break } } }
                        if (!k) throw "Could not automatically determine field data. Please see https://datatables.net/tn/11";
                        b[k] || (b[k] = {});
        ...
        _focusListener: function() {
            ...
            if ("focus" === f) d.on("key-focus.autoFill", function(c, d, b) { a._attach(b.node()) }).on("key-blur.autoFill", function(c, d, b) { a._detach() });
            else if ("click" === f) b(d.table().body()).on("click" + c, "td, th", function(c) { a._attach(this) }), b(h.body).on("click" + c, function(c) {
        ...
        _mousedown: function(a) {
            ...
            b(h.body).on("mousemove.autoFill", function(a) { d._mousemove(a) }).on("mouseup.autoFill", function(a) { d._mouseup(a) });
        ...
        _mouseup: function(a) {
            ...
            if (f.row !== e.row || f.column !== e.column) {
                var g = c.cell(":eq(" + f.row + ")", f.column + ":visible", { page: "current" });
                if (b("div.DTE", g.node()).length) {
                    var n = c.editor();
                    n.on("submitSuccess.dtaf close.dtaf", function() {
                        n.off(".dtaf");
                        setTimeout(function() { d._mouseup(a) }, 100)
                    }).on("submitComplete.dtaf preSubmitCancelled.dtaf close.dtaf", function() { n.off(".dtaf") });
                    n.submit()
                } else {
                    var k = this._range(f.row, e.row);
                    f = this._range(f.column, e.column);
                    e = [];
                    for (var l = c.settings()[0], r = l.aoColumns, q = 0; q < k.length; q++) e.push(b.map(f, function(a) {
                        var d = c.row(":eq(" + k[q] + ")", { page: "current" });
                        a = c.cell(d.index(), a + ":visible");
                        d = a.data();
                        var b = a.index(),
                            f = r[b.column].editField;
                        f !== m && (d = l.oApi._fnGetObjectDataFn(f)(c.row(b.row).data()));
                        return {
                            cell: a,
                            data: d,
                            label: a.data(),
        ...
        _shiftScroll: function(a) {
            ...
            null !== c.dtTop && a.pageY < c.dtTop + 65 ? l = -5 : null !== c.dtTop && a.pageY > c.dtTop + c.dtHeight -
                65 && (l = 5);
            null !== c.dtLeft && a.pageX < c.dtLeft + 65 ? m = -5 : null !== c.dtLeft && a.pageX > c.dtLeft + c.dtWidth - 65 && (m = 5);
            n || k || l || m ? (c.windowVert = n, c.windowHoriz = k, c.dtVert = l, c.dtHoriz = m, b = !0) : this.s.scrollInterval && (clearInterval(this.s.scrollInterval), this.s.scrollInterval = null);
            ...
            if (!1 !== a) {
                ...
                if (null !== this.c.update ? this.c.update : !this.c.editor) {
                    for (var b = 0, e = d.length; b < e; b++)
                        for (var g = 0, h = d[b].length; g < h; g++) { var k = d[b][g]; - 1 !== c.indexOf(k.index.column) && k.cell.data(k.set) }
                    a.draw(!1)
                }
    ...
    k.actions = {
        increment: {
            ...
            option: function(a, b) { return a.i18n("autoFill.increment", 'Increment / decrement each cell by: <input type="number" value="1">') },
            execute: function(a, d, c) {
                a = 1 * d[0][0].data;
                c = 1 * b("input", c).val();
                for (var f = 0, e = d.length; f < e; f++)
                    for (var g = 0, h = d[f].length; g < h; g++) d[f][g].set = a, a += c
            }
        },
        fill: {
            available: function(a, b) { return !0 },
            option: function(a, b) { return a.i18n("autoFill.fill", "Fill all cells with <i>" + b[0][0].label + "</i>") },
        ...
        fillHorizontal: {
            available: function(a, b) { return 1 < b.length && 1 < b[0].length },
            option: function(a, b) { return a.i18n("autoFill.fillHorizontal", "Fill cells horizontally") },
            execute: function(a, b, c) {
                a = 0;
        ...
        fillVertical: {
            available: function(a, b) { return 1 < b.length && 1 < b[0].length },
            option: function(a, b) { return a.i18n("autoFill.fillVertical", "Fill cells vertically") },
            execute: function(a, b, c) {
                a = 0;
                for (c =
                    b.length; a < c; a++)
    ...
    r.register("autoFill()", function() { return this });
    r.register("autoFill().enabled()", function() {
        var a = this.context[0];
        return a.autoFill ?
            a.autoFill.enabled() : !1
    });
    r.register("autoFill().enable()", function(a) { return this.iterator("table", function(b) { b.autoFill && b.autoFill.enable(a) }) });
    r.register("autoFill().disable()", function() { return this.iterator("table", function(a) { a.autoFill && a.autoFill.disable() }) });
    b(h).on("preInit.dt.autofill", function(a, d, c) { "dt" === a.namespace && (a = d.oInit.autoFill, c = l.defaults.autoFill, a || c) && (c = b.extend({}, a, c), !1 !== a && new k(d, c)) });
    l.AutoFill = k;
    return l.AutoFill = k
});
...
(function(d) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(q) { return d(q, window, document) }) : "object" === typeof exports ? module.exports = function(q, n) {
        q || (q = window);
    ...
    d.extend(t.prototype, {
        ...
        text: function(a, b) {
            ...
            var e = this.s.dt,
                f = d(c.node),
                g = function(a) { return "function" === typeof a ? a(e, f, c.conf) : a };
        ...
        _buildButton: function(a, b) {
            ...
            var v = a.clickBlurs === l ? !0 : a.clickBlurs,
                m = d("<" + f + "/>").addClass(c.className).attr("tabindex", this.s.dt.settings()[0].iTabIndex).attr("aria-controls", this.s.dt.table().node().id).on("click.dtb", function(b) {
                    ...
                    v && m.blur()
                }).on("keyup.dtb", function(b) { 13 === b.keyCode && !m.hasClass(c.disabled) && a.action && k(b, g, m, a) });
                ...
                if (!a) {
                    ...
                    setTimeout(function() {
                        ...
                        d("body").on("click.dtb-collection",
                            ...
                            }).on("keyup.dtb-collection", function(a) { 27 === a.keyCode && f() });
    ...
    p.Api.register("buttons()", function(a, b) {
        ...
        var c = this.iterator(!0, "table", function(c) { if (c._buttons) return t.buttonSelector(t.instanceSelector(a, c._buttons), b) }, !0);
        c._groupSelector = a;
        return c
    });
...
(function(d) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(f) { return d(f, window, document) }) : "object" === typeof exports ? module.exports = function(f, g) { f || (f = window); if (!g || !g.fn.dataTable) g = require("datatables.net")(f, g).$; return d(g, f, f.document) } : d(jQuery, window, document) })(function(d, f, g, m) {
    ...
    d.extend(k.prototype, {
        ...
        _mouseDown: function(c, b) {
            ...
            e = this.dom.dtScroll;
            this.s.scroll = { windowHeight: d(f).height(), windowWidth: d(f).width(), dtTop: e.length ? e.offset().top : null, dtLeft: e.length ? e.offset().left : null, dtHeight: e.length ? e.outerHeight() : null, dtWidth: e.length ? e.outerWidth() : null }
        },
        _mouseMove: function(c) {
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !==
                e) 0 === e ? this.dom.target.prependTo(j) : (b = d.unique(i.rows({ page: "current" }).nodes().toArray()), e > this.s.lastInsert ? this.dom.target.insertAfter(b[e - 1]) : this.dom.target.insertBefore(b[e])), this._cachePositions(), this.s.lastInsert = e;
            this._shiftScroll(c)
        },
        _mouseUp: function() {
            var c = this,
            ...
            var r = function() {
                if (c.c.update) {
                    ...
                    for (e = h.length; a < e; a++) {
                        ...
                        m(d, h[a].newData);
                        b.columns().every(function() { this.dataSrc() === i && b.cell(h[a].node, this.index()).invalidate("data") })
                    }
                    c._emitEvent("row-reordered", q);
                    b.draw(!1)
                }
            };
            this.c.editor ? (this.c.enable = !1, this.c.editor.edit(l, !1, d.extend({ submit: "changed" }, this.c.formOptions)).multiSet(i, k).one("preSubmitCancelled.rowReorder", function() {
                c.c.enable = !0;
                c.c.editor.off(".rowReorder");
                b.draw(!1)
            }).one("submitUnsuccessful.rowReorder", function() { b.draw(!1) }).one("submitSuccess.rowReorder",
                function() { r() }).one("submitComplete", function() {
                c.c.enable = !0;
                c.c.editor.off(".rowReorder")
            }).submit()) : r()
        },
    ...
    k.defaults = { dataSrc: 0, editor: null, enable: !0, formOptions: {}, selector: "td:first-child", snapX: !1, update: !0, excludedChildren: "a" };
...
*/
(function(f) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function(k) { return f(k, window, document) }) : "object" === typeof exports ? module.exports = function(k, m) {
        k || (k = window);
    ...
    function n(a, b, c, d) { if (!d || a.flatten().length) "string" === typeof b && (b += ".dt"), c.unshift(a), f(a.table().node()).trigger(b, c) }
    ...
    function D(a) {
        ...
        b.on("preXhr.dt.dtSelect", function() {
            var a = b.rows({ selected: !0 }).ids(!0).filter(function(b) { return b !== h }),
                d = b.cells({ selected: !0 }).eq(0).map(function(a) { var c = b.row(a.row).id(!0); return c ? { row: c, column: a.column } : h }).filter(function(b) {
                    return b !==
                        h
                });
    ...
    function x(a) { a = a._eventNamespace; return "draw.dt.DT" + a + " select.dt.DT" + a + " deselect.dt.DT" + a }
    ...
    g.select.init = function(a) {
        ...
        f.fn.dataTable.ext.order["select-checkbox"] = function(b, a) { return this.api().column(a, { order: "index" }).nodes().map(function(a) { return "row" === b._select.items ? f(a).parent().hasClass(b._select.className) : "cell" === b._select.items ? f(a).hasClass(b._select.className) : !1 }) };
    ...
    p("select()", function() { return this.iterator("table", function(a) { g.select.init(new g.Api(a)) }) });
    p("select.blurable()", function(a) { return a === h ? this.context[0]._select.blurable : this.iterator("table", function(b) { b._select.blurable = a }) });
    ...
    q("rows().select()", "row().select()", function(a) {
        ...
        this.iterator("table", function(a, d) { n(b, "select", ["row", b[d]], !0) });
        return this
    });
    q("columns().select()", "column().select()", function(a) {
        ...
        this.iterator("table", function(a, d) { n(b, "select", ["column", b[d]], !0) });
        return this
    });
    q("cells().select()", "cell().select()", function(a) {
        ...
        this.iterator("table", function(a, d) { n(b, "select", ["cell", b[d]], !0) });
        return this
    });
    q("rows().deselect()", "row().deselect()", function() {
        ...
        this.iterator("table", function(b, c) { n(a, "deselect", ["row", a[c]], !0) });
        return this
    });
    q("columns().deselect()", "column().deselect()", function() {
        ...
        this.iterator("table", function(b, c) { n(a, "deselect", ["column", a[c]], !0) });
        return this
    });
    q("cells().deselect()", "cell().deselect()", function() {
        ...
        this.iterator("table", function(b, c) { n(a, "deselect", ["cell", a[c]], !0) });
        return this
    });
    var y = 0;
    f.extend(g.ext.buttons, {
        ...
        selectNone: {
            ...
            action: function() { r(this.settings()[0], !0) },
            init: function(a, b, c) {
                var d = this;
                c._eventNamespace = ".select" + y++;
                a.on(x(c), function() {
    ...
    f(m).on("preInit.dt.dtSelect", function(a, b) { "dt" === a.namespace && g.select.init(new g.Api(b)) });
    return g.select
});