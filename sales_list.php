     ...
     $(document).ready(function(){
        ...
        var lang = "<?php echo $dil["lang"];?>";
            ...
            else if(lang =='en')
         {
            ...
            $("#min").datepicker().datepicker("setDate", new Date());
            $("#max").datepicker().datepicker("setDate", new Date());
            document.getElementById("startTime").value = "00:00:00";
            document.getElementById("endTime").value = "23:59:59";
       ...
       ordering: false,
        ...
        "ajax": {
                ...
                error: function(cevap){
                    JSalert_NoSale("<?php echo $dil["noSales"];?>");
                   }
            },
        "columns": [
                {"data": "SaleDate"},
							 ...
							 <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <?php echo $dil["sale"];?> <strong> <?php echo $dil["filter"];?> </strong>
											...
											<div class="row form-group">
											  ...
											  <div class="row form-group">
												...
												<div class="col col-md-6">
												   ...
												   <input type="text" id="min" name="min" class="form-control" autocomplete="off">
												...
												<div class="col col-md-4">
												 ...
												 <div class="col col-md-6">
												    <div class="input-group">
												   <input type="time" id="startTime" name="startTime" class="form-control" autocomplete="off"  step="1">
                                                    <div class="input-group-addon">
												...
												<div class="col col-md-4">
												 ...
												 <div class="col col-md-6">
												    <div class="input-group">
												   <input type="text" id="max" name="max" class="form-control" autocomplete="off">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
                                                </div>
											  ...
											  <div class="row form-group">
                                               ...
                                               <div class="col col-md-6">
												    <div class="input-group">
												   <input type="time" id="endTime" name="endTime" class="form-control" autocomplete="off"  step="1">
                                                    <div class="input-group-addon">
