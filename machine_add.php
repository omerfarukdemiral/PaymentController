                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong><?php echo $dil["AddMachineTitle"];?></strong>
                                    </div>
                                     ...
                                     <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-8">
                                                    <input type="number" min="0" step="1" id="Address" name="Address" placeholder="" class="form-control" onkeypress="return isNumberKey(event)" onchange="AddressCheck(this.value)" autocomplete="off">
                                                </div>
                                                </div>
                                                <div class="row form-group">
                                                ...
                                                <div class="col col-md-8">
													<select name="PortID" id="PortID" class="form-control">
                                                        <option value="ttyAMA0">1</option>
                                                        <option value="ttyAMA1">2</option>
                                                        <option value="ttyAMA2">3</option>
                                                        <option value="ttyAMA3">4</option>
                                                    </select>                                              
												</div>
                                                </div>
												  <div class="row form-group">
                                                <div class="col col-md-4">
												 ...
												 <div class="col col-md-8">
                                                    <input type="number" min="0" step="1" id="" name="RepeatCount" placeholder="" class="form-control" onkeypress="return isNumberKey(event)">
                                                </div>
                                         </div>
                                       </div>
										<div class="col-lg-4">
                                            <div class="row form-group">
											 <div class="col col-md-4">
											  ...
											  <div class="col col-md-8">
                                                    <input type="number" min="0" step="1" id="" name="WakeUpCount" placeholder="" class="form-control" onkeypress="return isNumberKey(event)">
                                                </div>
												</div> 
												<div class="row form-group">
												  <div class="col col-md-4">
